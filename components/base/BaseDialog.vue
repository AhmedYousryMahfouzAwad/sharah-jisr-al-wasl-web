<template>
    <Dialog :visible="visible" :modal="modal" :header="header" class="md:max-w-xl max-w-7xl"
        @update:visible="updateVisible">


        <button type="button" label="Cancel" @click="handleCancel"
        ...
        <div class="flex justify-center gap-2 mt-4">
            <Button type="button" label="Cancel" v-show="show" severity="secondary" @click="handleCancel" />
            <ButtonAuth class="!w-28 my-5" type="button" v-show="show_accept" :label="t('pages.auth.of_course')"
                @click="handleSave" />
        </div>
    </Dialog>
</template>
